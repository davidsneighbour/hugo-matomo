...
[[module.imports]]
path = "github.com/dnb-org/dnb-hugo-matomo"
disable = false
ignoreConfig = false
ignoreImports = false
...
```bash
# update this module
hugo mod get -u github.com/dnb-org/dnb-hugo-matomo
# update to a specific version
hugo mod get -u github.com/dnb-org/dnb-hugo-matomo@v1.0.0
...
`dnb-hugo-matomo` implements template hooks via [`dnb-hugo-hooks`](https://github.com/dnb-org/dnb-hugo-hooks) and makes the following hooks available:
