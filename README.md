...
# David's Neighbour GoHugo Component / Matomo
...
`hugo-matomo` implements template hooks via [`hugo-hooks`](https://github.com/davidsneighbour/hugo-hooks) and makes the following hooks available:
...
## Sites and Projects using `hugo-matomo`
